  ...
  return (
    <div className="play-video">
      ...
      <div className="play-video-info">
        <p>
          {apiData ? value_converter(apiData.statistics.viewCount) : "N/A"}{" "}
          views &bull;{" "}
        ...
        <div>
          <span>
            <img src={like} alt="" />
            {apiData ? value_converter(apiData.statistics.likeCount) : "154"}
          </span>
          <span>
            <img src={dislike} alt="" />
          </span>
      ...
      <div className="vid-description">
        ...
        <hr />
        <h4>
          {apiData ? value_converter(apiData.statistics.commentCount) : "107"}{" "}
          Comments
        </h4>
